...
\begin{center}
    \includegraphics[width=0.95\textwidth]{Dissertation/images/program/main_in_progress.png}
    \captionof{figure}{Основной интерфейс программы}
    \label{fig:main_gui}
\end{center}

\begin{center}
    \includegraphics[width=0.95\textwidth]{Dissertation/images/program/main_completed.png}
    \captionof{figure}{Основной интерфейс программы после выполнения}
    \label{fig:main_completed}
\end{center}

\begin{center}
    \includegraphics[width=\textwidth]{Dissertation/images/program/main_gantt.png}
    \captionof{figure}{Интерфейс программы с диаграммой Ганта}
    \label{fig:main_gantt}
\end{center}


\begin{center}
    \includegraphics[width=\textwidth]{Dissertation/images/program/main_simulation.png}
    \captionof{figure}{Интерфейс программы с результатами имиитационного моделирования}
    \label{fig:main_simulation}
\end{center}
...
\begin{center}
    \includegraphics[width=\textwidth]{Dissertation/images/program/output_schedule_1.png}
    % \includegraphics[width=\textwidth]{Dissertation/images/program/output_schedule_2.png}
    % \includegraphics[height=0.3\textheight]{Dissertation/images/program/output_schedule_3.png}
...
\end{center}
 ...
 \begin{center}
     \includegraphics[width=0.95\textheight, angle=90]{Dissertation/images/packages_models.pdf}
 ...
 \begin{center}
     \includegraphics[width=0.95\textwidth]{Dissertation/images/classes_models.pdf}
     \captionof{figure}{UML-схема классов модельного слоя \texttt{models}}
     \label{fig:uml-classes-models}
 \end{center}

 \begin{center}
     \includegraphics[width=\textwidth]{Dissertation/images/packages_simulation.pdf}
     \captionof{figure}{UML-схема пакетов слоя иммитационного-моделирования \texttt{simulation}}
     \label{fig:uml-packages-simulation}
 \end{center}
 \begin{center}
     \includegraphics[width=0.95\textwidth]{Dissertation/images/classes_simulation.pdf}
     \captionof{figure}{UML-схема классов слоя иммитационного-моделирования \texttt{simulation}}
     \label{fig:uml-classes-simulation}
 \end{center}

 
 

 \chapter{Полный перечень заказов тестового экземпляра Кондопожского ЦБК}
 \label{app:ktsbk_orders}

В~таблице~\ref{tab:ktsbk_orders_full} приведён полный перечень заказов тестового экземпляра \texttt{KTsBK} (раздел~\ref{sec:software/experiments_ktsbk}), сформированного на~основе номенклатуры раскроя Кондопожского ЦБК.

\begin{longtable}{|c|c|c|c|c|c|c|}
\caption{Заказы тестового экземпляра \texttt{KTsBK}}\label{tab:ktsbk_orders_full}\\
\hline
Заказ & Ширина, мм & Количество & Марка & Плотность & Слои & БРС \\
\hline
\endfirsthead
...
\endhead
\hline
\multicolumn{7}{r}{\small\slshape продолжение на следующей странице} \\
\endfoot
\hline
\endlastfoot
O1 & 200 & 2 & C0000001 & 100 & 1 & да \\
O2 & 210 & 1 & C0000001 & 100 & 1 & да \\
O3 & 600 & 2 & C0000001 & 100 & 1 & да \\
O4 & 620 & 11 & C0000001 & 100 & 1 & да \\
O5 & 700 & 8 & C0000001 & 100 & 1 & да \\
O6 & 720 & 7 & C0000001 & 100 & 1 & нет \\
O7 & 770 & 2 & C0000001 & 100 & 1 & нет \\
O8 & 800 & 1 & C0000001 & 100 & 1 & нет \\
O9 & 840 & 23 & C0000001 & 100 & 1 & нет \\
O10 & 880 & 25 & C0000001 & 100 & 1 & нет \\
O11 & 900 & 2 & C0000001 & 100 & 1 & нет \\
O12 & 950 & 5 & C0000001 & 100 & 1 & нет \\
O13 & 970 & 16 & C0000001 & 100 & 1 & нет \\
O14 & 1000 & 1 & C0000001 & 100 & 1 & нет \\
O15 & 1010 & 19 & C0000001 & 100 & 1 & нет \\
O16 & 1020 & 16 & C0000001 & 100 & 1 & нет \\
O17 & 1050 & 35 & C0000001 & 100 & 1 & нет \\
O18 & 1060 & 10 & C0000001 & 100 & 1 & нет \\
O19 & 1080 & 4 & C0000001 & 100 & 1 & нет \\
O20 & 1120 & 2 & C0000001 & 100 & 1 & нет \\
O21 & 1150 & 1 & C0000001 & 100 & 1 & нет \\
O22 & 1160 & 2 & C0000001 & 100 & 1 & нет \\
O23 & 1170 & 2 & C0000001 & 100 & 1 & нет \\
O24 & 1200 & 15 & C0000001 & 100 & 1 & нет \\
O25 & 1205 & 7 & C0000001 & 100 & 1 & нет \\
O26 & 1250 & 61 & B0000002 & 125 & 2 & нет \\
O27 & 1260 & 24 & B0000002 & 125 & 1 & нет \\
O28 & 1300 & 1 & B0000002 & 125 & 1 & нет \\
O29 & 1400 & 36 & B0000002 & 125 & 1 & нет \\
O30 & 1450 & 51 & B0000002 & 125 & 2 & нет \\
O31 & 1500 & 17 & B0000002 & 125 & 1 & нет \\
O32 & 1550 & 2 & B0000002 & 125 & 1 & нет \\
O33 & 1575 & 2 & B0000002 & 125 & 1 & нет \\
O34 & 1600 & 21 & B0000002 & 125 & 1 & нет \\
O35 & 1650 & 19 & B0000002 & 125 & 1 & нет \\
O36 & 1670 & 4 & B0000002 & 125 & 1 & нет \\
O37 & 1700 & 3 & B0000002 & 125 & 1 & нет \\
O38 & 1800 & 10 & B0000002 & 125 & 1 & нет \\
O39 & 2000 & 10 & B0000002 & 125 & 1 & нет \\
O40 & 2100 & 20 & B0000002 & 125 & 1 & нет \\
O41 & 2200 & 9 & B0000002 & 125 & 1 & нет \\
O42 & 2340 & 2 & B0000002 & 125 & 1 & нет \\
O43 & 2380 & 2 & B0000002 & 125 & 1 & нет \\
O44 & 2400 & 11 & B0000002 & 125 & 1 & нет \\
O45 & 2500 & 8 & B0000002 & 125 & 1 & нет \\
\end{longtable}
