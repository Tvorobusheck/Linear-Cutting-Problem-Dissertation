...
\includepdf{images/2024611544_program_registration.pdf}
...
\begin{figure}
    ...
    \caption{Основной интерфейс программы}
    \label{fig:main_gui}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{Dissertation/images/program/main_in_progress.png}
    \caption{Интерфейс программы в процессе выполнения}
    \label{fig:main_in_progress}
\end{figure}


\begin{figure}
    \includegraphics[width=\textwidth]{Dissertation/images/program/input_csv.png}
    \caption{CSV-файл с вводными данными}
    \label{fig:input_csv}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{Dissertation/images/program/output_xlsx.png}
    \caption{XLSX-файл с выходными данными}
    \label{fig:output_xlsx}
\end{figure}
...
\end{itemize}
 ...
 \begin{figure}[p]
     ...
     \caption{UML-схема пакетов алгоритмического модуля \texttt{algo}}
 ...
 \begin{figure}[p]
     ...
     \caption{UML-схема классов алгоритмического модуля \texttt{algo}}
 ...
 \begin{figure}[p]
     ...
     \caption{UML-схема пакетов модельного слоя \texttt{models}}
 ...
 \begin{figure}[p]
     ...
     \caption{UML-схема классов модельного слоя \texttt{models}}
     \label{fig:uml-classes-models}
 \end{figure}
 
 \chapter{Отчёт о покрытии кода тестами}
 \label{app:coverage-report}
 \includepdf[pages=-]{Dissertation/images/Coverage report.pdf}
