...
В~таблице~\ref{tab:ktsbk_orders_full} приведён полный перечень заказов теста (раздел~\ref{sec:software/experiments_ktsbk}), сформированного на~основе номенклатуры раскроя Кондопожского ЦБК.

\begin{longtable}{|c|c|c|c|c|c|c|}
\caption{Заказы теста по данным Кондопожского ЦБК}\label{tab:ktsbk_orders_full}\\
\hline
