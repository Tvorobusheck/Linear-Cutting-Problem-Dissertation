...
\begin{frame}
    \frametitle{Генерация расписания}
    Каждая операция $\overline{Z}=(h,\overline{h},e,d,z,\overline{T},\overline{\overline{T}},\overline{t'})$
    ...
    \vspace{0.2cm}
    \begin{itemize}
        \item Склад $\overline{T}$ обновляется при каждой операции
...
\begin{frame}
    ...
    \small
    При каждой операции $\overline{Z}$ склад обновляется:

    \vspace{0.2cm}
    \textbf{Выпуск тамбура} ($e{=}0$): тамбур попадает в~$\overline{\overline{T}}$ (зарезервированное содержимое складов); станет доступен в~$\overline{T}$ (содержимое складов), когда $h_{\text{след}} \ge \overline{h}_{\text{тек}}$
