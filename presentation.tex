...
\appendix
\input{Presentation/appendix}      % TODO: Запасные слайды презентации, с ответами на замечания
\input{Presentation/reserved_brs_and_storage.tex}
\input{Presentation/reserved_knives_setups_calculation.tex}
\input{Presentation/reserved_generation.tex}
\input{Presentation/reserved_mutation_example.tex}
\input{Presentation/reserved_novelity.tex}
\end{document}
